...
$login_fun = $_SESSION['usuario'];
$sql_login = "SELECT * from funcionario where login_fun = '{$login_fun}'";
$resultado_login = mysqli_query($conexao, $sql_login);
$dados = mysqli_fetch_array($resultado_login);
?>
...
<form action="../funcoes/frequencia_adm.php" method="POST">
  <div class="form-row">
    <div class="form-group col-md-4">
      <label >Horário Inicial</label>
      <input type="text" class="form-control" name="horario_inicial" value="08:00">
    </div>
    <div class="form-group col-md-4">
      <label>Horário Final</label>
      <input type="text" class="form-control" name="horario_final" value="14:00">
    </div>
  </div>
  <div class="form-row">
  <div class="form-group col-md-6">
    <h5><?php echo $dados['nome_fun']?></h5>
    <input type="hidden" class="form-control" name="nome" value="<?php echo $dados['nome_fun'];?>">
  </div>
  </div>
