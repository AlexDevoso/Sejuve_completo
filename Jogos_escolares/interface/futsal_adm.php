<?php
  ...
  $mostrarModalidadem15 = "SELECT modalidade_coletivaid from modalidade_coletiva where nome_mc = 'futsal' and categoria_mc = 'masculino' and naipe_mc = '15a17'";
  ...
  $mostrarModalidadef15 = "SELECT modalidade_coletivaid from modalidade_coletiva where nome_mc = 'futsal' and categoria_mc = 'feminino' and naipe_mc = '15a17'";
...
<td style="text-align: center;"> <button class="btn btn-danger" type="submit" name="delete_adm"><i style="color: #fff !important;" class="fas fa-trash" ></i></button></td>
</form>
  <?php 
