...
<form action="../funcoes/cadastrar_comissao_escola.php" method="POST">
  <input type="hidden" name="idescola" value="<?php echo $str; ?>">
  <input type="hidden" name="modalidade_coletiva" value="<?php echo $_SESSION['modalidade'][4]; ?>">
  ...
  <div class="form-row">
    ...
    <div class="col">
      <label>Nome:</label> 
      <input type="text" name="nome_tecnico" class="form-control" placeholder="Nome Completo">
    </div>
 ...
 <div class="col-md-4">
    ...
    <label>RG:</label>
    <input type="text" name="rg_tecnico" class="form-control" placeholder="000.000.000-0">
    ...
    <div class="col-md-4">
      <label>CREF:</label>
      <input type="text" class="form-control" name="cref_tecnico">
    </div>
