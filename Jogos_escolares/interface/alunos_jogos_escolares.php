...
.pesquisar_input input,button {
  ...
  <title>Jogos Escolares - Alunos</title>
...
<script type="text/javascript">
  ...
  <div class="d-flex" id="wrapper">
    ...
    <form style="width: 100%;" class="" method="GET">
    <center>
     
      <input  class="pesquisar_input" name="pesquisa"  type="search" placeholder="Pesquisar" aria-label="Search" style="margin: 10px;float:  !important;">
...
<a href="cadastrar_escola_je.php"  style="float: right;" class="btn btn-primary">Novo Atleta</a>
